...
export const LoginPage: React.FC = () => {
   ...
   return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 relative overflow-hidden" style={{ fontFamily: 'Outfit, sans-serif' }}>
         ...
         <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-gradient-to-tr from-yellow-200/40 via-purple-300/40 to-green-200/40 rounded-full blur-[100px] animate-pulse" />
         <div className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] bg-gradient-to-bl from-blue-200/30 via-pink-200/30 to-orange-100/30 rounded-full blur-[120px]" />
         ...
         <div className="bg-white p-8 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] w-full max-w-md border-2 border-black animate-slide-down relative z-10">
            <div className="flex flex-col items-center justify-center gap-2 mb-8">
               ...
               <h1 className="text-4xl font-black text-black tracking-tight mb-1">Login Here</h1>
               <p className="text-black font-bold">Welcome back to Healix AI</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
               ...
               <div className="space-y-2">
                  <label className="text-sm font-bold text-black uppercase tracking-wider ml-1">Email or Phone</label>
               ...
               <div className="flex justify-end">
                  <button type="button" className="text-xs font-black text-black hover:underline uppercase tracking-widest italic">
                     Forgot Password?
                  </button>
               </div>
               ...
               <button
                  type="submit"
                  className="w-full bg-black text-white py-5 rounded-2xl font-black uppercase tracking-[0.2em] hover:bg-slate-900 transition-all hover:scale-[1.02] active:scale-[0.98] shadow-2xl flex items-center justify-center gap-3 group"
               >
            ...
            <div className="mt-10 text-center text-sm">
               <span className="text-black font-bold italic">Don't have an account?</span>{' '}
               <Link to="/register" className="text-black font-black hover:underline uppercase tracking-tighter ml-1 text-base">
                  Create Account
               </Link>
            </div>
         </div>
